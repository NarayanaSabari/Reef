...
async def test_write_memory_tool_persists_and_confirms(store):
    ...
    msg = await tools["write_memory"](key="mornings", value="brief")
    assert "brief" in msg
